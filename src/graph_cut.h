...
void ComputeMinGraphCutStoerWagner( const std::vector<std::pair<int, int>>& edges,
...
std::unordered_map<int, int> ComputeNormalizedMinGraphCut(const std::vector<std::pair<int, int>>& edges,
